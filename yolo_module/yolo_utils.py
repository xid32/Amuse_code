...
from yolo_module.nets.yolo import YoloBody
from yolo_module.utils.utils import (cvtColor, get_classes, preprocess_input,
                         resize_image, show_config)
from yolo_module.utils.utils_bbox import DecodeBox


class YOLO(object):
    _defaults = {

        "model_path"        : './yolo/model_data/yolov8_x.pth',
